...
import {View,Text,Image,TouchableOpacity,StyleSheet, ImageBackground, Platform, Alert} from 'react-native'
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{
                            marginTop:Platform.OS=="android"?120:150,
                        }}>
                            <View style={{
                    ...
                    <ScrollView 
                    style={{marginTop:Platform.OS==="android"?20:40,}}
                    horizontal
                    ...
                    >
                        ...
                        <TouchableOpacity onPress={()=>Alert.alert("Item Added In Cart!")}>
                            <View style={{
                                backgroundColor:"#000",
                                flexDirection:"row",
                                alignItems:"center",
